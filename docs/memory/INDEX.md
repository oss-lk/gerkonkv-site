...
- **Durable reasoning:** [`DECISIONS.md`](DECISIONS.md) plus the existing domain documents linked below.
...
| Quality/research history and expensive Stage8 findings | [`../../rocketdict/START_HERE.md`](../../rocketdict/START_HERE.md), [`../../rocketdict/RESEARCH_STATUS.md`](../../rocketdict/RESEARCH_STATUS.md), [`DECISIONS.md`](DECISIONS.md) | `../../rocketdict/research/`, `../../rocketdict-ci/`, Git history/artifacts |
